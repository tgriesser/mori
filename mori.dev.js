...
cljs.core._invoke = function() {
  var a = null, b = function(a) {
  ...
  }, C = function(a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, w) {
    ...
    return C.call(null, a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, w);
  }, J = function(a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, w, C) {
    if (a ? a.cljs$core$IFn$_invoke$arity$21 : a) {
      return a.cljs$core$IFn$_invoke$arity$21(a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, w, C);
    }
    var J;
    ...
    return J.call(null, a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, w, C);
...
cljs.core.MetaFn.prototype.call = function() {
  ...
  }, C = function(a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, P) {
    return this.afn.call(null, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, P);
  }, J = function(a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, P, w) {
    return this.afn.call(null, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, P, w);
  }, P = function(a, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, P, w, C) {
    return cljs.core.apply.call(null, this.afn, b, c, d, e, f, g, h, k, l, m, n, q, p, r, s, t, u, v, P, w, C);
...
cljs.core.nil_iter = function nil_iter() {
  "undefined" === typeof cljs.core.t5654 && (cljs.core.t5654 = function(b, c) {
    this.nil_iter = b;
    this.meta5655 = c;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
  }, cljs.core.t5654.cljs$lang$type = !0, cljs.core.t5654.cljs$lang$ctorStr = "cljs.core/t5654", cljs.core.t5654.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write.call(null, c, "cljs.core/t5654");
  }, cljs.core.t5654.prototype.hasNext = function() {
    return!1;
  }, cljs.core.t5654.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t5654.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t5654.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta5655;
  }, cljs.core.t5654.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t5654(this.nil_iter, c);
  }, cljs.core.__GT_t5654 = function(b, c) {
    return new cljs.core.t5654(b, c);
  });
  return new cljs.core.t5654(nil_iter, null);
};
...
clojure.data.diff_associative_key = function(a, b, c) {
  var d = cljs.core.get.call(null, a, c), e = cljs.core.get.call(null, b, c), f = clojure.data.diff.call(null, d, e), g = cljs.core.nth.call(null, f, 0, null), h = cljs.core.nth.call(null, f, 1, null), f = cljs.core.nth.call(null, f, 2, null);
  a = cljs.core.contains_QMARK_.call(null, a, c);
  b = cljs.core.contains_QMARK_.call(null, b, c);
  d = a && b && (null != f || null == d && null == e);
  return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [!a || null == g && d ? null : new cljs.core.PersistentArrayMap.fromArray([c, g], !0, !1), !b || null == h && d ? null : new cljs.core.PersistentArrayMap.fromArray([c, h], !0, !1), d ? new cljs.core.PersistentArrayMap.fromArray([c, f], !0, !1) : null], null);
};
...
clojure.data.equality_partition = function(a) {
  if (a ? a.clojure$data$EqualityPartition$equality_partition$arity$1 : a) {
...
clojure.data.diff_similar = function(a, b) {
  if (a ? a.clojure$data$Diff$diff_similar$arity$2 : a) {
...
clojure.data.equality_partition._ = function(a) {
  return(a ? a.cljs$lang$protocol_mask$partition0$ & 1024 || a.cljs$core$IMap$ || (a.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IMap, a)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IMap, a)) ? new cljs.core.Keyword(null, "map", "map", 1371690461) : (a ? a.cljs$lang$protocol_mask$partition0$ & 4096 || a.cljs$core$ISet$ || (a.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.ISet, a)) : 
  cljs.core.native_satisfies_QMARK_.call(null, cljs.core.ISet, a)) ? new cljs.core.Keyword(null, "set", "set", 304602554) : (a ? a.cljs$lang$protocol_mask$partition0$ & 16777216 || a.cljs$core$ISequential$ || (a.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.ISequential, a)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.ISequential, a)) ? new cljs.core.Keyword(null, "sequential", "sequential", -1082983960) : new cljs.core.Keyword(null, 
  "atom", "atom", -397043653);
};
clojure.data.EqualityPartition["boolean"] = !0;
clojure.data.equality_partition["boolean"] = function(a) {
  return new cljs.core.Keyword(null, "atom", "atom", -397043653);
};
clojure.data.EqualityPartition["function"] = !0;
clojure.data.equality_partition["function"] = function(a) {
  return new cljs.core.Keyword(null, "atom", "atom", -397043653);
};
clojure.data.EqualityPartition.array = !0;
clojure.data.equality_partition.array = function(a) {
  return new cljs.core.Keyword(null, "sequential", "sequential", -1082983960);
};
clojure.data.EqualityPartition.number = !0;
clojure.data.equality_partition.number = function(a) {
  return new cljs.core.Keyword(null, "atom", "atom", -397043653);
};
clojure.data.EqualityPartition.string = !0;
clojure.data.equality_partition.string = function(a) {
  return new cljs.core.Keyword(null, "atom", "atom", -397043653);
};
clojure.data.EqualityPartition["null"] = !0;
clojure.data.equality_partition["null"] = function(a) {
  return new cljs.core.Keyword(null, "atom", "atom", -397043653);
};
clojure.data.Diff._ = !0;
clojure.data.diff_similar._ = function(a, b) {
  return function() {
    switch(clojure.data.equality_partition.call(null, a) instanceof cljs.core.Keyword ? clojure.data.equality_partition.call(null, a).fqn : null) {
      case "map":
      ...
      default:
        throw Error("No matching clause: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.data.equality_partition.call(null, a)));;
    }
  }().call(null, a, b);
};
...
var mori = {};
mori.apply = cljs.core.apply;
goog.exportSymbol("mori.apply", mori.apply);
mori.count = cljs.core.count;
goog.exportSymbol("mori.count", mori.count);
mori.distinct = cljs.core.distinct;
goog.exportSymbol("mori.distinct", mori.distinct);
mori.empty = cljs.core.empty;
goog.exportSymbol("mori.empty", mori.empty);
mori.first = cljs.core.first;
goog.exportSymbol("mori.first", mori.first);
mori.second = cljs.core.second;
goog.exportSymbol("mori.second", mori.second);
mori.next = cljs.core.next;
goog.exportSymbol("mori.next", mori.next);
mori.rest = cljs.core.rest;
goog.exportSymbol("mori.rest", mori.rest);
mori.seq = cljs.core.seq;
goog.exportSymbol("mori.seq", mori.seq);
mori.conj = cljs.core.conj;
goog.exportSymbol("mori.conj", mori.conj);
mori.cons = cljs.core.cons;
goog.exportSymbol("mori.cons", mori.cons);
mori.find = cljs.core.find;
goog.exportSymbol("mori.find", mori.find);
mori.nth = cljs.core.nth;
goog.exportSymbol("mori.nth", mori.nth);
mori.last = cljs.core.last;
goog.exportSymbol("mori.last", mori.last);
mori.assoc = cljs.core.assoc;
goog.exportSymbol("mori.assoc", mori.assoc);
mori.dissoc = cljs.core.dissoc;
goog.exportSymbol("mori.dissoc", mori.dissoc);
mori.get_in = cljs.core.get_in;
goog.exportSymbol("mori.get_in", mori.get_in);
mori.update_in = cljs.core.update_in;
goog.exportSymbol("mori.update_in", mori.update_in);
mori.assoc_in = cljs.core.assoc_in;
goog.exportSymbol("mori.assoc_in", mori.assoc_in);
mori.fnil = cljs.core.fnil;
goog.exportSymbol("mori.fnil", mori.fnil);
mori.disj = cljs.core.disj;
goog.exportSymbol("mori.disj", mori.disj);
mori.pop = cljs.core.pop;
goog.exportSymbol("mori.pop", mori.pop);
mori.peek = cljs.core.peek;
goog.exportSymbol("mori.peek", mori.peek);
mori.hash = cljs.core.hash;
goog.exportSymbol("mori.hash", mori.hash);
mori.get = cljs.core.get;
goog.exportSymbol("mori.get", mori.get);
mori.has_key = cljs.core.contains_QMARK_;
goog.exportSymbol("mori.has_key", mori.has_key);
mori.is_empty = cljs.core.empty_QMARK_;
goog.exportSymbol("mori.is_empty", mori.is_empty);
mori.reverse = cljs.core.reverse;
goog.exportSymbol("mori.reverse", mori.reverse);
mori.take = cljs.core.take;
goog.exportSymbol("mori.take", mori.take);
mori.drop = cljs.core.drop;
goog.exportSymbol("mori.drop", mori.drop);
mori.take_nth = cljs.core.take_nth;
goog.exportSymbol("mori.take_nth", mori.take_nth);
mori.partition = cljs.core.partition;
goog.exportSymbol("mori.partition", mori.partition);
mori.partition_all = cljs.core.partition_all;
goog.exportSymbol("mori.partition_all", mori.partition_all);
mori.partition_by = cljs.core.partition_by;
goog.exportSymbol("mori.partition_by", mori.partition_by);
mori.iterate = cljs.core.iterate;
goog.exportSymbol("mori.iterate", mori.iterate);
mori.into = cljs.core.into;
goog.exportSymbol("mori.into", mori.into);
mori.merge = cljs.core.merge;
goog.exportSymbol("mori.merge", mori.merge);
mori.merge_with = cljs.core.merge_with;
goog.exportSymbol("mori.merge_with", mori.merge_with);
mori.subvec = cljs.core.subvec;
goog.exportSymbol("mori.subvec", mori.subvec);
mori.take_while = cljs.core.take_while;
goog.exportSymbol("mori.take_while", mori.take_while);
mori.drop_while = cljs.core.drop_while;
goog.exportSymbol("mori.drop_while", mori.drop_while);
mori.group_by = cljs.core.group_by;
goog.exportSymbol("mori.group_by", mori.group_by);
mori.interpose = cljs.core.interpose;
goog.exportSymbol("mori.interpose", mori.interpose);
mori.interleave = cljs.core.interleave;
goog.exportSymbol("mori.interleave", mori.interleave);
mori.concat = cljs.core.concat;
goog.exportSymbol("mori.concat", mori.concat);
mori.conj1 = function(a, b) {
  return cljs.core._conj.call(null, a, b);
};
goog.exportSymbol("mori.conj1", mori.conj1);
mori.sequential_or_array_QMARK_ = function(a) {
  return a instanceof Array || cljs.core.sequential_QMARK_.call(null, a);
};
mori.flatten = function(a) {
  return cljs.core.filter.call(null, function(a) {
    return!mori.sequential_or_array_QMARK_.call(null, a);
  }, cljs.core.rest.call(null, cljs.core.tree_seq.call(null, mori.sequential_or_array_QMARK_, mori.seq, a)));
};
goog.exportSymbol("mori.flatten", mori.flatten);
mori.lazy_seq = function(a) {
  return new cljs.core.LazySeq(null, a, null, null);
};
goog.exportSymbol("mori.lazy_seq", mori.lazy_seq);
mori.keys = cljs.core.keys;
goog.exportSymbol("mori.keys", mori.keys);
mori.select_keys = cljs.core.select_keys;
goog.exportSymbol("mori.select_keys", mori.select_keys);
mori.vals = cljs.core.vals;
goog.exportSymbol("mori.vals", mori.vals);
mori.prim_seq = cljs.core.prim_seq;
goog.exportSymbol("mori.prim_seq", mori.prim_seq);
mori.map = cljs.core.map;
goog.exportSymbol("mori.map", mori.map);
mori.map_indexed = cljs.core.map_indexed;
goog.exportSymbol("mori.map_indexed", mori.map_indexed);
mori.mapcat = cljs.core.mapcat;
goog.exportSymbol("mori.mapcat", mori.mapcat);
mori.reduce = cljs.core.reduce;
goog.exportSymbol("mori.reduce", mori.reduce);
mori.reduce_kv = cljs.core.reduce_kv;
goog.exportSymbol("mori.reduce_kv", mori.reduce_kv);
mori.mapv = cljs.core.mapv;
goog.exportSymbol("mori.mapv", mori.mapv);
mori.filterv = cljs.core.filterv;
goog.exportSymbol("mori.filterv", mori.filterv);
mori.keep = cljs.core.keep;
goog.exportSymbol("mori.keep", mori.keep);
mori.keep_indexed = cljs.core.keep_indexed;
goog.exportSymbol("mori.keep_indexed", mori.keep_indexed);
mori.filter = cljs.core.filter;
goog.exportSymbol("mori.filter", mori.filter);
mori.remove = cljs.core.remove;
goog.exportSymbol("mori.remove", mori.remove);
mori.some = cljs.core.some;
goog.exportSymbol("mori.some", mori.some);
mori.every = cljs.core.every_QMARK_;
goog.exportSymbol("mori.every", mori.every);
mori.equals = cljs.core._EQ_;
goog.exportSymbol("mori.equals", mori.equals);
mori.range = cljs.core.range;
goog.exportSymbol("mori.range", mori.range);
mori.repeat = cljs.core.repeat;
goog.exportSymbol("mori.repeat", mori.repeat);
mori.repeatedly = cljs.core.repeatedly;
goog.exportSymbol("mori.repeatedly", mori.repeatedly);
mori.sort = cljs.core.sort;
goog.exportSymbol("mori.sort", mori.sort);
mori.sort_by = cljs.core.sort_by;
goog.exportSymbol("mori.sort_by", mori.sort_by);
mori.into_array = cljs.core.into_array;
goog.exportSymbol("mori.into_array", mori.into_array);
mori.subseq = cljs.core.subseq;
goog.exportSymbol("mori.subseq", mori.subseq);
mori.flatmap = cljs.core.flatmap;
goog.exportSymbol("mori.flatmap", mori.flatmap);
mori.dedupe = cljs.core.dedupe;
goog.exportSymbol("mori.dedupe", mori.dedupe);
mori.transduce = cljs.core.transduce;
goog.exportSymbol("mori.transduce", mori.transduce);
mori.iteration = cljs.core.iteration;
goog.exportSymbol("mori.iteration", mori.iteration);
mori.sequence = cljs.core.sequence;
goog.exportSymbol("mori.sequence", mori.sequence);
mori.list = cljs.core.list;
goog.exportSymbol("mori.list", mori.list);
mori.vector = cljs.core.vector;
goog.exportSymbol("mori.vector", mori.vector);
mori.array_map = cljs.core.array_map;
goog.exportSymbol("mori.array_map", mori.array_map);
mori.hash_map = cljs.core.hash_map;
goog.exportSymbol("mori.hash_map", mori.hash_map);
mori.set = cljs.core.set;
goog.exportSymbol("mori.set", mori.set);
mori.sorted_set = cljs.core.sorted_set;
goog.exportSymbol("mori.sorted_set", mori.sorted_set);
mori.sorted_set_by = cljs.core.sorted_set_by;
goog.exportSymbol("mori.sorted_set_by", mori.sorted_set_by);
mori.sorted_map = cljs.core.sorted_map;
goog.exportSymbol("mori.sorted_map", mori.sorted_map);
mori.sorted_map_by = cljs.core.sorted_map_by;
goog.exportSymbol("mori.sorted_map_by", mori.sorted_map_by);
mori.queue = function() {
  var a = function(a) {
    return mori.into.call(null, cljs.core.PersistentQueue.EMPTY, a);
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d);
...
goog.exportSymbol("mori.queue", mori.queue);
mori.keyword = cljs.core.keyword;
goog.exportSymbol("mori.keyword", mori.keyword);
mori.symbol = cljs.core.symbol;
goog.exportSymbol("mori.symbol", mori.symbol);
mori.zipmap = cljs.core.zipmap;
goog.exportSymbol("mori.zipmap", mori.zipmap);
mori.is_list = cljs.core.list_QMARK_;
goog.exportSymbol("mori.is_list", mori.is_list);
mori.is_seq = cljs.core.seq_QMARK_;
goog.exportSymbol("mori.is_seq", mori.is_seq);
mori.is_vector = cljs.core.vector_QMARK_;
goog.exportSymbol("mori.is_vector", mori.is_vector);
mori.is_map = cljs.core.map_QMARK_;
goog.exportSymbol("mori.is_map", mori.is_map);
mori.is_set = cljs.core.set_QMARK_;
goog.exportSymbol("mori.is_set", mori.is_set);
mori.is_keyword = cljs.core.keyword_QMARK_;
goog.exportSymbol("mori.is_keyword", mori.is_keyword);
mori.is_symbol = cljs.core.symbol_QMARK_;
goog.exportSymbol("mori.is_symbol", mori.is_symbol);
mori.is_collection = cljs.core.coll_QMARK_;
goog.exportSymbol("mori.is_collection", mori.is_collection);
mori.is_sequential = cljs.core.sequential_QMARK_;
goog.exportSymbol("mori.is_sequential", mori.is_sequential);
mori.is_associative = cljs.core.associative_QMARK_;
goog.exportSymbol("mori.is_associative", mori.is_associative);
mori.is_counted = cljs.core.counted_QMARK_;
goog.exportSymbol("mori.is_counted", mori.is_counted);
mori.is_indexed = cljs.core.indexed_QMARK_;
goog.exportSymbol("mori.is_indexed", mori.is_indexed);
mori.is_reduceable = cljs.core.reduceable_QMARK_;
goog.exportSymbol("mori.is_reduceable", mori.is_reduceable);
mori.is_seqable = cljs.core.seqable_QMARK_;
goog.exportSymbol("mori.is_seqable", mori.is_seqable);
mori.is_reversible = cljs.core.reversible_QMARK_;
goog.exportSymbol("mori.is_reversible", mori.is_reversible);
mori.union = clojure.set.union;
goog.exportSymbol("mori.union", mori.union);
mori.intersection = clojure.set.intersection;
goog.exportSymbol("mori.intersection", mori.intersection);
mori.difference = clojure.set.difference;
goog.exportSymbol("mori.difference", mori.difference);
mori.join = clojure.set.join;
goog.exportSymbol("mori.join", mori.join);
mori.index = clojure.set.index;
goog.exportSymbol("mori.index", mori.index);
mori.project = clojure.set.project;
goog.exportSymbol("mori.project", mori.project);
mori.map_invert = clojure.set.map_invert;
goog.exportSymbol("mori.map_invert", mori.map_invert);
mori.rename = clojure.set.rename;
goog.exportSymbol("mori.rename", mori.rename);
mori.rename_keys = clojure.set.rename_keys;
goog.exportSymbol("mori.rename_keys", mori.rename_keys);
mori.is_subset = clojure.set.subset_QMARK_;
goog.exportSymbol("mori.is_subset", mori.is_subset);
mori.is_superset = clojure.set.superset_QMARK_;
goog.exportSymbol("mori.is_superset", mori.is_superset);
mori.not_equals = cljs.core.not_EQ_;
goog.exportSymbol("mori.not_equals", mori.not_equals);
mori.gt = cljs.core._GT_;
goog.exportSymbol("mori.gt", mori.gt);
mori.gte = cljs.core._GT__EQ_;
goog.exportSymbol("mori.gte", mori.gte);
mori.lt = cljs.core._LT_;
goog.exportSymbol("mori.lt", mori.lt);
mori.lte = cljs.core._LT__EQ_;
goog.exportSymbol("mori.lte", mori.lte);
mori.compare = cljs.core.compare;
goog.exportSymbol("mori.compare", mori.compare);
mori.partial = cljs.core.partial;
goog.exportSymbol("mori.partial", mori.partial);
mori.comp = cljs.core.comp;
goog.exportSymbol("mori.comp", mori.comp);
mori.pipeline = function() {
  var a = function(a) {
    return mori.reduce.call(null, function(a, b) {
      return b.call(null, a);
    }, a);
  }, b = function(b) {
    var d = null;
...
goog.exportSymbol("mori.pipeline", mori.pipeline);
mori.curry = function() {
  var a = function(a, b) {
    return function(e) {
      return cljs.core.apply.call(null, a, mori.cons.call(null, e, b));
    };
  }, b = function(b, d) {
    var e = null;
    1 < arguments.length && (e = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0));
...
goog.exportSymbol("mori.curry", mori.curry);
mori.juxt = function() {
  var a = function(a) {
    return function() {
      var b = function(b) {
        return mori.into_array.call(null, mori.map.call(null, function(a) {
      ...
      e.cljs$core$IFn$_invoke$arity$variadic = b;
      return e;
    }();
  }, b = function(b) {
    var d = null;
...
goog.exportSymbol("mori.juxt", mori.juxt);
mori.knit = function() {
  var a = function(a) {
    return function(b) {
      return mori.into_array.call(null, mori.map.call(null, function(a, b) {
        return a.call(null, b);
      }, a, b));
    };
  }, b = function(b) {
...
goog.exportSymbol("mori.knit", mori.knit);
mori.diff = clojure.data.diff;
goog.exportSymbol("mori.diff", mori.diff);
mori.sum = function(a, b) {
  return a + b;
};
goog.exportSymbol("mori.sum", mori.sum);
mori.inc = function(a) {
  return a + 1;
};
goog.exportSymbol("mori.inc", mori.inc);
mori.dec = function(a) {
  return a - 1;
};
goog.exportSymbol("mori.dec", mori.dec);
mori.is_even = function(a) {
  return 0 === cljs.core.mod.call(null, a, 2);
};
goog.exportSymbol("mori.is_even", mori.is_even);
mori.is_odd = function(a) {
  return 1 === cljs.core.mod.call(null, a, 2);
};
goog.exportSymbol("mori.is_odd", mori.is_odd);
mori.each = function(a, b) {
  for (var c = cljs.core.seq.call(null, a), d = null, e = 0, f = 0;;) {
    if (f < e) {
      ...
      if (c = cljs.core.seq.call(null, c)) {
        d = c, cljs.core.chunked_seq_QMARK_.call(null, d) ? (c = cljs.core.chunk_first.call(null, d), e = cljs.core.chunk_rest.call(null, d), d = c, g = cljs.core.count.call(null, c), c = e, e = g) : (g = cljs.core.first.call(null, d), b.call(null, g), c = cljs.core.next.call(null, d), d = null, e = 0), f = 0;
      } else {
        return null;
      }
    }
...
goog.exportSymbol("mori.each", mori.each);
mori.identity = cljs.core.identity;
goog.exportSymbol("mori.identity", mori.identity);
mori.constantly = cljs.core.constantly;
goog.exportSymbol("mori.constantly", mori.constantly);
mori.clj_to_js = cljs.core.clj__GT_js;
goog.exportSymbol("mori.clj_to_js", mori.clj_to_js);
mori.js_to_clj = function() {
  var a = null, b = function(a) {
...
goog.exportSymbol("mori.js_to_clj", mori.js_to_clj);
mori.parse = function(a) {
  return cljs.reader.read_string.call(null, a);
};
goog.exportSymbol("mori.parse", mori.parse);
mori.configure = function(a, b) {
  switch(a) {
    case "print-length":
      return cljs.core._STAR_print_length_STAR_ = b;
    case "print-level":
      return cljs.core._STAR_print_level_STAR_ = b;
    default:
      throw Error("No matching clause: " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(a));;
  }
};
goog.exportSymbol("mori.configure", mori.configure);
mori.meta = cljs.core.meta;
goog.exportSymbol("mori.meta", mori.meta);
mori.with_meta = cljs.core.with_meta;
goog.exportSymbol("mori.with_meta", mori.with_meta);
mori.vary_meta = cljs.core.vary_meta;
goog.exportSymbol("mori.vary_meta", mori.vary_meta);
mori.alter_meta = cljs.core.alter_meta_BANG_;
goog.exportSymbol("mori.alter_meta", mori.alter_meta);
mori.reset_meta = cljs.core.reset_meta_BANG_;
goog.exportSymbol("mori.reset_meta", mori.reset_meta);
...
mori.extend_to_iassociative = function(a, b) {
  a.cljs$core$IAssociative$ = !0;
  a.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = function(a) {
    return function(a, c) {
      return b.contains_key.call(this, c);
    };
  }(a);
  a.cljs$core$IAssociative$_assoc$arity$3 = function(a) {
    return function(a, c, f) {
      return b.assoc.call(this, c, f);
    };
  }(a);
  return a;
};
mori.extend_to_icloneable = function(a, b) {
  a.cljs$core$ICloneable$ = !0;
  a.cljs$core$ICloneable$_clone$arity$1 = function(a) {
    return function(a) {
      return b.clone.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_icollection = function(a, b) {
  a.cljs$core$ICollection$ = !0;
  a.cljs$core$ICollection$_conj$arity$2 = function(a) {
    return function(a, c) {
      return b.conj.call(this, c);
    };
  }(a);
  return a;
};
mori.extend_to_icounted = function(a, b) {
  a.cljs$core$ICounted$ = !0;
  a.cljs$core$ICounted$_count$arity$1 = function(a) {
    return function(a) {
      return b.count.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_iencodeclojure = function(a, b) {
  a.cljs$core$IEncodeClojure$ = !0;
  a.cljs$core$IEncodeClojure$_js__GT_clj$arity$2 = function(a) {
    return function(a, c) {
      return b.toClj.call(this, c);
    };
  }(a);
  return a;
};
mori.extend_to_iencodejs = function(a, b) {
  a.cljs$core$IEncodeJS$ = !0;
  a.cljs$core$IEncodeJS$_clj__GT_js$arity$1 = function(a) {
    return function(a) {
      return b.toJS.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_iequiv = function(a, b) {
  a.cljs$core$IEquiv$ = !0;
  a.cljs$core$IEquiv$_equiv$arity$2 = function(a) {
    return function(a, c) {
      return b.equiv.call(this, c);
    };
  }(a);
  return a;
};
mori.extend_to_ihash = function(a, b) {
  a.cljs$core$IHash$ = !0;
  a.cljs$core$IHash$_hash$arity$1 = function(a) {
    return function(a) {
      return b.hash.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_iindexed = function(a, b) {
  a.cljs$core$IIndexed$ = !0;
  a.cljs$core$IIndexed$_nth$arity$2 = function(a) {
    return function(a, c) {
      return b.nth.call(this, c);
    };
  }(a);
  a.cljs$core$IIndexed$_nth$arity$3 = function(a) {
    return function(a, c, f) {
      return b.nth.call(this, c, f);
    };
  }(a);
  return a;
};
mori.extend_to_ikvreduce = function(a, b) {
  a.cljs$core$IKVReduce$ = !0;
  a.cljs$core$IKVReduce$_kv_reduce$arity$3 = function(a) {
    return function(a, c, f) {
      return b.reduce_kv.call(this, c, f);
    };
  }(a);
  return a;
};
mori.extend_to_ilookup = function(a, b) {
  a.cljs$core$ILookup$ = !0;
  a.cljs$core$ILookup$_lookup$arity$2 = function(a) {
    return function(a, c) {
      return b.lookup.call(this, c);
    };
  }(a);
  a.cljs$core$ILookup$_lookup$arity$3 = function(a) {
    return function(a, c, f) {
      return b.lookup.call(this, c, f);
    };
  }(a);
  return a;
};
mori.extend_to_imap = function(a, b) {
  a.cljs$core$IMap$ = !0;
  a.cljs$core$IMap$_dissoc$arity$2 = function(a) {
    return function(a, c) {
      return b.dissoc.call(this, c);
    };
  }(a);
  return a;
};
mori.extend_to_imeta = function(a, b) {
  a.cljs$core$IMeta$ = !0;
  a.cljs$core$IMeta$_meta$arity$1 = function(a) {
    return function(a) {
      return b.meta.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_iseq = function(a, b) {
  a.cljs$core$ISeq$ = !0;
  a.cljs$core$ISeq$_first$arity$1 = function(a) {
    return function(a) {
      return b.first.call(this);
    };
  }(a);
  a.cljs$core$ISeq$_rest$arity$1 = function(a) {
    return function(a) {
      return b.rest.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_iseqable = function(a, b) {
  a.cljs$core$ISeqable$ = !0;
  a.cljs$core$ISeqable$_seq$arity$1 = function(a) {
    return function(a) {
      return b.seq.call(this);
    };
  }(a);
  return a;
};
mori.extend_to_iwithmeta = function(a, b) {
  a.cljs$core$IWithMeta$ = !0;
  a.cljs$core$IWithMeta$_with_meta$arity$2 = function(a) {
    return function(a, c) {
      return b.withMeta.call(this, c);
    };
  }(a);
  return a;
};
mori.extend_BANG_ = function(a, b, c) {
  switch(a) {
    case "IAssociative":
      return mori.extend_to_iassociative.call(null, b, c);
    case "ICloneable":
      return mori.extend_to_icloneable.call(null, b, c);
    case "ICollection":
      return mori.extend_to_icollection.call(null, b, c);
    case "ICounted":
      return mori.extend_to_icounted.call(null, b, c);
    case "IEncodeClojure":
      return mori.extend_to_iencodeclojure.call(null, b, c);
    case "IEncodeJS":
      return mori.extend_to_iencodejs.call(null, b, c);
    case "IEquiv":
      return mori.extend_to_iequiv.call(null, b, c);
    case "IHash":
      return mori.extend_to_ihash.call(null, b, c);
    case "IIndexed":
      return mori.extend_to_iindexed.call(null, b, c);
    case "IKVReduce":
      return mori.extend_to_ikvreduce.call(null, b, c);
    case "ILookup":
      return mori.extend_to_ilookup.call(null, b, c);
    case "IMap":
      return mori.extend_to_imap.call(null, b, c);
    case "IMeta":
      return mori.extend_to_imeta.call(null, b, c);
    case "ISeq":
      return mori.extend_to_iseq.call(null, b, c);
    case "ISeqable":
      return mori.extend_to_iseqable.call(null, b, c);
    case "IWithMeta":
      return mori.extend_to_iwithmeta.call(null, b, c);
    default:
      throw Error("Cannot extend to " + cljs.core.str.cljs$core$IFn$_invoke$arity$1(a));;
  }
};
mori.extend = function(a, b) {
  goog.object.forEach(b, function(b, d, e) {
    return mori.extend_BANG_.call(null, d, a, b);
  });
  return a;
};
goog.exportSymbol("mori.extend", mori.extend);
mori._equiv = function(a, b) {
  return a.equiv(b);
};
goog.exportSymbol("mori._equiv", mori._equiv);
mori._keys = function(a) {
  return a.keys();
};
goog.exportSymbol("mori._keys", mori._keys);
mori._values = function(a) {
  return a.values();
};
goog.exportSymbol("mori._values", mori._values);
mori._entries = function(a) {
  return a.entries();
};
goog.exportSymbol("mori._entries", mori._entries);
mori._has = function(a) {
  return a.has();
};
goog.exportSymbol("mori._has", mori._has);
mori._get = function(a) {
  return a.get();
};
goog.exportSymbol("mori._get", mori._get);
mori._forEach = function(a) {
  return a.forEach();
};
goog.exportSymbol("mori._forEach", mori._forEach);
mori._next = function(a) {
  return a.next();
};
goog.exportSymbol("mori._next", mori._next);
mori.mutable = {};
...
mori.mutable.conj1 = function(a, b) {
  return cljs.core._conj_BANG_.call(null, a, b);
};
goog.exportSymbol("mori.mutable.conj1", mori.mutable.conj1);
...
cognitect.transit.write_handler = function() {
  var a = null, b = function(b, c) {
    ...
    "undefined" === typeof cognitect.transit.t6562 && (cognitect.transit.t6562 = function(a, b, c, d, e, f) {
      ...
      this.cljs$lang$protocol_mask$partition1$ = 0;
      this.cljs$lang$protocol_mask$partition0$ = 393216;
    }, cognitect.transit.t6562.cljs$lang$type = !0, cognitect.transit.t6562.cljs$lang$ctorStr = "cognitect.transit/t6562", cognitect.transit.t6562.cljs$lang$ctorPrWriter = function(a, b, c) {
      return cljs.core._write.call(null, b, "cognitect.transit/t6562");
    }, cognitect.transit.t6562.prototype.tag = function(a) {
      return this.tag_fn.call(null, a);
    }, cognitect.transit.t6562.prototype.rep = function(a) {
      return this.rep_fn.call(null, a);
    }, cognitect.transit.t6562.prototype.stringRep = function(a) {
      return cljs.core.truth_(this.str_rep_fn) ? this.str_rep_fn.call(null, a) : null;
    }, cognitect.transit.t6562.prototype.getVerboseHandler = function() {
      return cljs.core.truth_(this.verbose_handler_fn) ? this.verbose_handler_fn.call(null) : null;
    }, cognitect.transit.t6562.prototype.cljs$core$IMeta$_meta$arity$1 = function(a) {
      return this.meta6563;
    }, cognitect.transit.t6562.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
      return new cognitect.transit.t6562(this.verbose_handler_fn, this.str_rep_fn, this.rep_fn, this.tag_fn, this.write_handler, b);
    }, cognitect.transit.__GT_t6562 = function(a, b, c, d, e, f) {
      return new cognitect.transit.t6562(a, b, c, d, e, f);
    });
    return new cognitect.transit.t6562(h, d, c, b, a, null);
  }, a = function(a, f, g, h) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, f);
...
mori.transit = {};
mori.transit.read = cognitect.transit.read;
goog.exportSymbol("mori.transit.read", mori.transit.read);
mori.transit.write = cognitect.transit.write;
goog.exportSymbol("mori.transit.write", mori.transit.write);
mori.transit.reader = cognitect.transit.reader;
goog.exportSymbol("mori.transit.reader", mori.transit.reader);
mori.transit.writer = cognitect.transit.writer;
goog.exportSymbol("mori.transit.writer", mori.transit.writer);
clojure.core = {};
clojure.core.reducers = {};
clojure.core.reducers.fjtask = function(a) {
  return a;
};
clojure.core.reducers.fjinvoke = function(a) {
  return a.call(null);
};
clojure.core.reducers.fjfork = function(a) {
  return a;
};
clojure.core.reducers.fjjoin = function(a) {
  return a.call(null);
};
clojure.core.reducers.reduce = function() {
  var a = null, b = function(b, c) {
    ...
    return cljs.core.map_QMARK_.call(null, c) ? cljs.core._kv_reduce.call(null, c, a, b) : null == c ? b : c instanceof Array ? cljs.core.array_reduce.call(null, c, a, b) : cljs.core._reduce.call(null, c, a, b);
  }, a = function(a, e, f) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, e);
...
clojure.core.reducers.coll_fold = function(a, b, c, d) {
  if (a ? a.clojure$core$reducers$CollFold$coll_fold$arity$4 : a) {
    return a.clojure$core$reducers$CollFold$coll_fold$arity$4(a, b, c, d);
  }
  var e;
  e = clojure.core.reducers.coll_fold[goog.typeOf(null == a ? null : a)];
  if (!e && (e = clojure.core.reducers.coll_fold._, !e)) {
    throw cljs.core.missing_protocol.call(null, "CollFold.coll-fold", a);
  }
  return e.call(null, a, b, c, d);
};
clojure.core.reducers.fold = function() {
  var a = null, b = function(b, c) {
    ...
    return a.call(null, 512, b, c, d);
  }, d = function(a, b, c, d) {
    return clojure.core.reducers.coll_fold.call(null, d, a, b, c);
  }, a = function(a, f, g, h) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, f);
...
clojure.core.reducers.reducer = function reducer(b, c) {
  "undefined" === typeof clojure.core.reducers.t6404 && (clojure.core.reducers.t6404 = function(b, c, f, g) {
    this.xf = b;
    this.coll = c;
    this.reducer = f;
    this.meta6405 = g;
  ...
  }, clojure.core.reducers.t6404.cljs$lang$type = !0, clojure.core.reducers.t6404.cljs$lang$ctorStr = "clojure.core.reducers/t6404", clojure.core.reducers.t6404.cljs$lang$ctorPrWriter = function(b, c, f) {
    return cljs.core._write.call(null, c, "clojure.core.reducers/t6404");
  }, clojure.core.reducers.t6404.prototype.cljs$core$IReduce$_reduce$arity$2 = function(b, c) {
    return cljs.core._reduce.call(null, this, c, c.call(null));
  }, clojure.core.reducers.t6404.prototype.cljs$core$IReduce$_reduce$arity$3 = function(b, c, f) {
    return cljs.core._reduce.call(null, this.coll, this.xf.call(null, c), f);
  }, clojure.core.reducers.t6404.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta6405;
  }, clojure.core.reducers.t6404.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new clojure.core.reducers.t6404(this.xf, this.coll, this.reducer, c);
  }, clojure.core.reducers.__GT_t6404 = function(b, c, f, g) {
    return new clojure.core.reducers.t6404(b, c, f, g);
  });
  return new clojure.core.reducers.t6404(c, b, reducer, null);
};
clojure.core.reducers.folder = function folder(b, c) {
  "undefined" === typeof clojure.core.reducers.t6410 && (clojure.core.reducers.t6410 = function(b, c, f, g) {
    this.xf = b;
    this.coll = c;
    this.folder = f;
    this.meta6411 = g;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 917504;
  }, clojure.core.reducers.t6410.cljs$lang$type = !0, clojure.core.reducers.t6410.cljs$lang$ctorStr = "clojure.core.reducers/t6410", clojure.core.reducers.t6410.cljs$lang$ctorPrWriter = function(b, c, f) {
    return cljs.core._write.call(null, c, "clojure.core.reducers/t6410");
  }, clojure.core.reducers.t6410.prototype.clojure$core$reducers$CollFold$ = !0, clojure.core.reducers.t6410.prototype.clojure$core$reducers$CollFold$coll_fold$arity$4 = function(b, c, f, g) {
    return clojure.core.reducers.coll_fold.call(null, this.coll, c, f, this.xf.call(null, g));
  }, clojure.core.reducers.t6410.prototype.cljs$core$IReduce$_reduce$arity$2 = function(b, c) {
    return cljs.core._reduce.call(null, this.coll, this.xf.call(null, c), c.call(null));
  }, clojure.core.reducers.t6410.prototype.cljs$core$IReduce$_reduce$arity$3 = function(b, c, f) {
    return cljs.core._reduce.call(null, this.coll, this.xf.call(null, c), f);
  }, clojure.core.reducers.t6410.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta6411;
  }, clojure.core.reducers.t6410.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new clojure.core.reducers.t6410(this.xf, this.coll, this.folder, c);
  }, clojure.core.reducers.__GT_t6410 = function(b, c, f, g) {
    return new clojure.core.reducers.t6410(b, c, f, g);
  });
  return new clojure.core.reducers.t6410(c, b, folder, null);
};
  ...
  var a = null, b = function() {
    ...
    return clojure.core.reducers.folder.call(null, b, function(b) {
      return function() {
        ...
        c.cljs$core$IFn$_invoke$arity$0 = d;
        c.cljs$core$IFn$_invoke$arity$2 = h;
        return c;
      }();
    });
  }, a = function(a) {
      ...
      return function(a) {
        return function() {
          var c = null, d = function() {
            ...
            cljs.core.swap_BANG_.call(null, a, cljs.core.dec);
            return 0 > cljs.core.deref.call(null, a) ? cljs.core.reduced.call(null, c) : b.call(null, c, d);
          }, m = function(c, d, e) {
            cljs.core.swap_BANG_.call(null, a, cljs.core.dec);
            return 0 > cljs.core.deref.call(null, a) ? cljs.core.reduced.call(null, c) : b.call(null, c, d, e);
          }, c = function(a, b, c) {
            switch(arguments.length) {
              case 0:
                return d.call(this);
      ...
      return function(a) {
        return function() {
          var c = null, d = function() {
            ...
            cljs.core.swap_BANG_.call(null, a, cljs.core.dec);
            return 0 > cljs.core.deref.call(null, a) ? b.call(null, c, d) : c;
          }, m = function(c, d, e) {
            cljs.core.swap_BANG_.call(null, a, cljs.core.dec);
            return 0 > cljs.core.deref.call(null, a) ? b.call(null, c, d, e) : c;
          }, c = function(a, b, c) {
            switch(arguments.length) {
              case 0:
                return d.call(this);
...
clojure.core.reducers.Cat.cljs$lang$ctorPrWriter = function(a, b, c) {
  return cljs.core._write.call(null, b, "clojure.core.reducers/Cat");
};
clojure.core.reducers.Cat.prototype.clojure$core$reducers$CollFold$ = !0;
clojure.core.reducers.Cat.prototype.clojure$core$reducers$CollFold$coll_fold$arity$4 = function(a, b, c, d) {
  return cljs.core._reduce.call(null, this, d);
};
...
clojure.core.reducers.Cat.prototype.cljs$core$ISeqable$_seq$arity$1 = function(a) {
  return cljs.core.concat.call(null, cljs.core.seq.call(null, this.left), cljs.core.seq.call(null, this.right));
};
clojure.core.reducers.Cat.prototype.cljs$core$ICounted$_count$arity$1 = function(a) {
  return this.cnt;
};
clojure.core.reducers.__GT_Cat = function(a, b, c) {
  return new clojure.core.reducers.Cat(a, b, c);
};
...
clojure.core.reducers.foldvec = function foldvec(b, c, d, e) {
  if (cljs.core.empty_QMARK_.call(null, b)) {
    return d.call(null);
  }
  if (cljs.core.count.call(null, b) <= c) {
    return clojure.core.reducers.reduce.call(null, e, d.call(null), b);
  }
  var f = cljs.core.quot.call(null, cljs.core.count.call(null, b), 2), g = cljs.core.subvec.call(null, b, 0, f);
  b = cljs.core.subvec.call(null, b, f, cljs.core.count.call(null, b));
  var h = function(b, f, g) {
    return function(h) {
      return function(b, f, g) {
        return function() {
          return foldvec.call(null, h, c, d, e);
        };
      }(b, f, g);
    };
  }(f, g, b);
  return clojure.core.reducers.fjinvoke.call(null, function(b, c, e, f) {
    return function() {
      var b = f.call(null, c), g = clojure.core.reducers.fjtask.call(null, f.call(null, e));
      clojure.core.reducers.fjfork.call(null, g);
      return d.call(null, b.call(null), clojure.core.reducers.fjjoin.call(null, g));
    };
  }(f, g, b, h));
};
cljs.core.PersistentVector.prototype.clojure$core$reducers$CollFold$ = !0;
cljs.core.PersistentVector.prototype.clojure$core$reducers$CollFold$coll_fold$arity$4 = function(a, b, c, d) {
  return clojure.core.reducers.foldvec.call(null, this, b, c, d);
};
clojure.core.reducers.CollFold.object = !0;
clojure.core.reducers.coll_fold.object = function(a, b, c, d) {
  return clojure.core.reducers.reduce.call(null, d, c.call(null), a);
};
clojure.core.reducers.CollFold["null"] = !0;
clojure.core.reducers.coll_fold["null"] = function(a, b, c, d) {
  return c.call(null);
};
mori.reducers = {};
mori.reducers.map = clojure.core.reducers.map;
goog.exportSymbol("mori.reducers.map", mori.reducers.map);
mori.reducers.filter = clojure.core.reducers.filter;
goog.exportSymbol("mori.reducers.filter", mori.reducers.filter);
mori.reducers.remove = clojure.core.reducers.remove;
goog.exportSymbol("mori.reducers.remove", mori.reducers.remove);
mori.reducers.take = clojure.core.reducers.take;
goog.exportSymbol("mori.reducers.take", mori.reducers.take);
mori.reducers.take_while = clojure.core.reducers.take_while;
goog.exportSymbol("mori.reducers.take_while", mori.reducers.take_while);
mori.reducers.drop = clojure.core.reducers.drop;
goog.exportSymbol("mori.reducers.drop", mori.reducers.drop);
mori.reducers.flatten = clojure.core.reducers.flatten;
goog.exportSymbol("mori.reducers.flatten", mori.reducers.flatten);
